...
from flask import Flask, Response, request, session, g, redirect, url_for, abort, render_template, flash, jsonify, Blueprint
...
@bp.route('/api/variants_in_gene/<gene_id>')
@require_agreement_to_terms_and_store_destination
...
@bp.route('/api/variants_in_region/<region_id>')
@require_agreement_to_terms_and_store_destination
...
@bp.route('/api/coverage/region/<region_id>')
@require_agreement_to_terms_and_store_destination
...
app.register_blueprint(bp, url_prefix = '/freeze3a/hg19')
